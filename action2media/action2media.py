...
def get_utc_offset():
    ...
    time_offset_hours = str(abs(utc_offset))
    if(copysign(1,utc_offset) == -1.0):
        time_offset_sign = "-"
    elif(copysign(1,utc_offset) == 1.0):
        time_offset_sign = "+"
    else:
        print("ERROR: Undetermined sign of UTC Offset")
    return time_offset_sign, time_offset_hours
...
if __name__ == '__main__':
    ...
    main("input","videos",".mp4",TimeOffsetSign=time_offset_sign,TimeOffsetHours=time_offset_hours)
